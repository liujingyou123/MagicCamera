package com.melody.mypreview.magic.render
...
class MagicRender(
    ...
    private var mCameraEngine: Engine? = null
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        mCameraEngine?.initConfig(mOESTextureId, mGLSurfaceView)
